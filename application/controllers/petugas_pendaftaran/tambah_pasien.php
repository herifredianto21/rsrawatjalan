...
<div class="container">  
  <form id="contact" action="" method="post">  
	...
	<form method="POST" action="<?php echo site_url('petugas_pendaftaran/c_pasien/proses_tambah_pasien'); ?>">
			...
			<input type="text" class="form-control" tabindex="1" required autofocus name="id_pasien" placeholder="id_pasien"/>
				<input type="text" class="form-control" name="nama_pasien" placeholder="nama_pasien"/>
				<input type="text" class="form-control" name="tgl_lahir" placeholder="tgl_lahir"/>
				<input type="text" class="form-control" name="jk" placeholder="jk"/>
				...
				<a href="<?php echo site_url ('c_pasien');?>">[ Home ]</a>
			</form>
		</fieldset>
		<hr>
		<p>

...
<body>
	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		...
		<ul class="nav menu">
			...
			<li><a href="<?php echo site_url('kasir/c_kasir/index'); ?>">Dashboard</a></li>
			<li><a href="<?php echo site_url('kasir/c_kasir/view_pembayaran'); ?>">Data pembayaran Poli</a></li>
			<li class="active"><a href="<?php echo site_url('kasir/c_kasir/view_pembayaran_obat'); ?>">Data pembayaran obat</a></li>
			<li role="presentation" class="divider"></li>
		...
		<div class="row">
			<div class="col-lg-12">
				<div class="panel panel-default">
					<div class="panel-heading"><h2>Pembayaran Obat</h2></div>
						...
						<div class="table table-responsive">
							<table class="table table-hover">
								...
								<?php foreach($pembayaranobat as $a)	{?>
									<tr id="hd" class="hd">

					...
					<br><br><br>
			     	...
			     	<form method="post" class="form-horizontal" role="form" action="<?php echo site_url('apoteker/Apoteker/proses_tambah_resep'); ?>">
						<div class="form-group">
							<label class="col-sm-2 control-label">id_resep</label>
							<div class="col-sm-4">
								<input type="text" value="<?php echo $id;?>" disabled/>
								<input type="hidden" name="id_resep" value = "<?php echo $id; ?>"/>
							</div>
						</div>
						...
						<div class="form-group">
							...
							<a href="<?php echo site_url ('apoteker/Apoteker/view_resep');?>">[ Home ]</a></td>
							</div>
						</div><br><br>

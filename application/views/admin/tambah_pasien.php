...
<div class="container">  
<form id="contact" method="post"  enctype="multipart/form-data" action="<?php echo site_url('c_pasien/proses_tambah_pasien'); ?>">
   

    <div>
        <span><label>ID PASIEN</label></span>
        <span><input type="text" class="form-control" name="id_pasien"/></span>
    </div>
      
    <div>
        <span><label>NAMA PASIEN</label></span>
        <span><input type="text" class="form-control" name="nama_pasien"/></span>
    </div>
